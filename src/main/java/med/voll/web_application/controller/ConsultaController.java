...
public class ConsultaController {
    ...
    @GetMapping
    public String carregarPaginaListagem(@PageableDefault Pageable paginacao, Model model, @AuthenticationPrincipal Usuario logadUsuario) {
        var consultasAtivas = service.listar(paginacao, logadUsuario);
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('ATENDENTE','PACIENTE')")
